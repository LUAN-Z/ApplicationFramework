...
class PomodoroPage(QWidget):
    ...
    def __init__(self, parent=None):
        ...
        # 状态持久化文件
        self.state_path = Path(__file__).resolve().parent / "pomodoro_state.json"
        self._load_state()
    ...
    def init_ui(self):
        ...
        self.count_label = BodyLabel(f"今日完成: {self.completed} 个番茄", timer_card)
    ...
    def _duration_row(self, text: str, parent):
        """生成一行 "标签 + 数值输入" 的配置行。"""
        row = QHBoxLayout()
